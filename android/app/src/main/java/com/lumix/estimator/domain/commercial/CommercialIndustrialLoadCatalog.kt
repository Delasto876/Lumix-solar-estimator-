...
object CommercialIndustrialLoadCatalog {
    ...
    val commercialLoads: List<LoadDefinition> = listOf(
        ...
        LoadDefinition("commercial_ac_package", "Air Conditioning (packaged/rooftop unit)", LoadCategory.COMMERCIAL, defaultRatedWatts = 7500.0, defaultVoltage = 240.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 0.85, isMotorLoad = true, defaultStartingSurgeMultiplier = 3.0, isAcLoad = true, defaultBtu = 75000.0),
    ...
    val industrialLoads: List<LoadDefinition> = listOf(
        ...
        LoadDefinition("industrial_large_hvac", "Large HVAC", LoadCategory.INDUSTRIAL, defaultRatedWatts = 20000.0, defaultVoltage = 415.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 0.85, isMotorLoad = true, defaultStartingSurgeMultiplier = 3.5, isAcLoad = true, defaultBtu = 200000.0),
        ...
        LoadDefinition("industrial_freezer", "Freezer (industrial)", LoadCategory.INDUSTRIAL, defaultRatedWatts = 8000.0, defaultVoltage = 415.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 0.85, defaultOperationType = LoadOperationType.CONTINUOUS, isMotorLoad = true, defaultStartingSurgeMultiplier = 4.0),
        LoadDefinition("industrial_cold_room", "Cold Room", LoadCategory.INDUSTRIAL, defaultRatedWatts = 6000.0, defaultVoltage = 415.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 0.85, defaultOperationType = LoadOperationType.CONTINUOUS, isMotorLoad = true, defaultStartingSurgeMultiplier = 4.0),
        LoadDefinition("industrial_mixer", "Industrial Mixer", LoadCategory.INDUSTRIAL, defaultRatedWatts = 5000.0, defaultVoltage = 415.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 0.82, defaultOperationType = LoadOperationType.INTERMITTENT, isMotorLoad = true, defaultStartingSurgeMultiplier = 3.5),
        LoadDefinition("industrial_oven", "Industrial Oven", LoadCategory.INDUSTRIAL, defaultRatedWatts = 15000.0, defaultVoltage = 415.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 1.0, defaultOperationType = LoadOperationType.INTERMITTENT),
        LoadDefinition("industrial_packaging_machine", "Packaging Machine", LoadCategory.INDUSTRIAL, defaultRatedWatts = 3000.0, defaultVoltage = 415.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 0.85, defaultOperationType = LoadOperationType.INTERMITTENT, isMotorLoad = true, defaultStartingSurgeMultiplier = 3.0),
        ...
        LoadDefinition("industrial_emergency_lighting", "Emergency Lighting (industrial)", LoadCategory.INDUSTRIAL, defaultRatedWatts = 100.0, defaultPowerFactor = 0.95, defaultOperationType = LoadOperationType.CONTINUOUS, defaultPriority = LoadPriority.CRITICAL),
        ...
        LoadDefinition("industrial_laundry_equipment", "Industrial Laundry Equipment", LoadCategory.INDUSTRIAL, defaultRatedWatts = 8000.0, defaultVoltage = 415.0, defaultPhase = LoadPhaseType.THREE_PHASE, defaultPowerFactor = 0.85, defaultOperationType = LoadOperationType.INTERMITTENT, isMotorLoad = true, defaultStartingSurgeMultiplier = 3.0),
